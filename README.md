In this project we try to make a defensive tool to discover phishing attack when emails are used as vector attacks, we collect raw data from the Phishing Email Dataset courtesy of Naser Abdullah Alam.
